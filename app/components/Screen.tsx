    ...
    <div className="flex grow flex-row text-primary transition-colors">
      ...
      >
        ...
        <div
          ...
          fixed bottom-0 z-[50] w-full overflow-hidden rounded-t-2xl md:border-r bg-screen-foreground shadow-[0px_-4px_32px_rgba(0,0,0,0.15)] transition duration-500 ease-in-out md:h-screen md:w-[300px] md:rounded-none md:shadow-none`}
        >
          <ToolsPanel />
        </div>
