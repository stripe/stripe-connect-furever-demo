...
declare module '@stripe/stripe' {
  namespace Stripe {
    ...
    export interface StripeConfig {
      ...
      /**
       * A function used to authenticate requests.
       */
      authenticator?: RequestAuthenticator;

      /**
       * Specify the value of Stripe-Context header to be sent with all requests.
       */
      stripeContext?: string;
    }

    /**
     * A function that authenticates the request
     */
    export type RequestAuthenticator = (request: Request) => Promise<void>;
    export interface Request {}
    export const createTemporaryV2ApiKeyAuthenticator: (
      apiKey: string
    ) => RequestAuthenticator;
    export const createRequestSigningAuthenticator: (
      keyId: string,
    ...
    export interface RequestOptions {
      ...
      /**
       * Specify the value of Stripe-Context header to be sent with this request.
       */
      stripeContext?: string;
    }
    ...
    interface AutoPagingContainer<TItem> {
      autoPagingEach: (
        handler: (item: TItem) => boolean | void | Promise<boolean | void>,
        onDone?: (err: any) => void
      ) => Promise<void>;
