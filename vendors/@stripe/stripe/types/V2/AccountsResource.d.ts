    ...
    namespace V2 {
      ...
      namespace AccountUpdateParams {
        ...
        namespace Configuration {
          interface RecipientData {
            /**
             * The payment method id to be used as a default outbound destination. This will allow the PaymentMethod to be omitted on OutboundPayments made through API or sending payouts via dashboard. Can also be explicitly set to `null` to clear the existing default outbound destination.
             */
