  ...
  namespace Stripe {
    namespace V2 {
      ...
      interface Account {
         ...
         */
        applied_configurations: Array<'recipient'>;
      ...
      namespace Account {
        ...
        namespace Configuration {
          interface RecipientData {
            /**
             * The payment method id to be used as a default outbound destination. This will allow the PaymentMethod to be omitted on OutboundPayments made through API or sending payouts via dashboard.
             */
          ...
          namespace RecipientData {
            interface DefaultOutboundDestination {
              /**
               * The payment method ID of the default outbound destination.
               */
              id: string;

              /**
               * Closed Enum. The payment method type of the default outbound destination.
               */
              type: DefaultOutboundDestination.Type;
            }

            namespace DefaultOutboundDestination {
              type Type = 'card' | 'gb_bank_account' | 'us_bank_account';
            }
