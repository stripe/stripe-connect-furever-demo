  ...
  namespace Stripe {
    namespace V2 {
      ...
      interface ReceivedCredit {
         ...
         */
        external_credit: ReceivedCredit.ExternalCredit | null;
      ...
      namespace ReceivedCredit {
        ...
        interface ExternalCredit {
           ...
           */
          payment_method_type: ExternalCredit.PaymentMethodType;
           ...
           */
          gb_bank_account: ExternalCredit.GbBankAccount | null;

          /**
           * Hash containing the transaction bank details. Present if `payment_method_type` field value is `us_bank_account`.
           */
          us_bank_account: ExternalCredit.UsBankAccount | null;
        }

        namespace ExternalCredit {
        ...
        type Type = 'balance_transfer' | 'external_credit';
      }
    }
  }
}
