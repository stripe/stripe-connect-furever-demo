...
///<reference path='./V2/EventTypes.d.ts' />
...
///<reference path='./V2/AdjustmentsResource.d.ts' />
///<reference path='./V2/Billing/BillableItemsResource.d.ts' />
...
///<reference path='./V2/Billing/PayersResource.d.ts' />
///<reference path='./V2/Billing/QuantityConfigsResource.d.ts' />
...
///<reference path='./V2/FinancialAccountsResource.d.ts' />
///<reference path='./V2/FinancialAddressesResource.d.ts' />
///<reference path='./V2/InboundTransfersResource.d.ts' />
///<reference path='./V2/OutboundPaymentsResource.d.ts' />
///<reference path='./V2/OutboundTransfersResource.d.ts' />
///<reference path='./V2/PaymentMethods/CardsResource.d.ts' />
///<reference path='./V2/PaymentMethods/GbBankAccountsResource.d.ts' />
///<reference path='./V2/PaymentMethods/OutboundDestinationsResource.d.ts' />
///<reference path='./V2/PaymentMethods/UsBankAccountsResource.d.ts' />
///<reference path='./V2/ReceivedCreditsResource.d.ts' />
///<reference path='./V2/ReceivedDebitsResource.d.ts' />
///<reference path='./V2/TestHelpers/FinancialAddressesResource.d.ts' />
///<reference path='./V2/TransactionEntriesResource.d.ts' />
///<reference path='./V2/TransactionsResource.d.ts' />
...
///<reference path='./V2/Billing/BillableItems.d.ts' />
...
///<reference path='./V2/Billing/Payers.d.ts' />
///<reference path='./V2/Billing/QuantityConfigs.d.ts' />
...
///<reference path='./V2/PaymentMethods/Cards.d.ts' />
///<reference path='./V2/PaymentMethods/GbBankAccounts.d.ts' />
///<reference path='./V2/PaymentMethods/OutboundDestinations.d.ts' />
///<reference path='./V2/PaymentMethods/UsBankAccounts.d.ts' />
///<reference path='./V2/Persons.d.ts' />
...
declare module '@stripe/stripe' {
  ...
  export class Stripe {
    ...
    constructor(
      apiKey: null,
      config: Stripe.StripeConfig & {authenticator: Stripe.RequestAuthenticator}
    );
    ...
    v2: {
      ...
      adjustments: Stripe.V2.AdjustmentsResource;
      financialAccounts: Stripe.V2.FinancialAccountsResource;
      financialAddresses: Stripe.V2.FinancialAddressesResource;
      inboundTransfers: Stripe.V2.InboundTransfersResource;
      outboundPayments: Stripe.V2.OutboundPaymentsResource;
      outboundTransfers: Stripe.V2.OutboundTransfersResource;
      receivedCredits: Stripe.V2.ReceivedCreditsResource;
      receivedDebits: Stripe.V2.ReceivedDebitsResource;
      transactions: Stripe.V2.TransactionsResource;
      transactionEntries: Stripe.V2.TransactionEntriesResource;
      core: {
      ...
      billing: {
        ...
        payers: Stripe.V2.Billing.PayersResource;
        rateCards: Stripe.V2.Billing.RateCardsResource;
        billableItems: Stripe.V2.Billing.BillableItemsResource;
        quantityConfigs: Stripe.V2.Billing.QuantityConfigsResource;
      };
      testHelper: {
        financialAddresses: Stripe.V2.TestHelpers.FinancialAddressesResource;
      };
      paymentMethod: {
        outboundDestinations: Stripe.V2.PaymentMethods.OutboundDestinationsResource;
        cards: Stripe.V2.PaymentMethods.CardsResource;
        gbBankAccounts: Stripe.V2.PaymentMethods.GbBankAccountsResource;
        usBankAccounts: Stripe.V2.PaymentMethods.UsBankAccountsResource;
      };
    };
