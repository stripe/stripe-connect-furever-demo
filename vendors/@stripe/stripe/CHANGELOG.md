...
## 0.59.0 - 2024-11-26
* [#721](https://github.com/stripe/stripe-node-next/pull/721) Update generated code for next
* [#720](https://github.com/stripe/stripe-node-next/pull/720) Update generated code for next
* [#719](https://github.com/stripe/stripe-node-next/pull/719) Update generated code for next
* [#718](https://github.com/stripe/stripe-node-next/pull/718) Update generated code for next
* [#708](https://github.com/stripe/stripe-node-next/pull/708) add pushed versions of strongly typed events
  
  - You can now parse thin events with `client.parseThinEvent__experimental`, which takes all the same arguments as the non-experimental version.  You can narrow the type of the object it returns. The narrowed type will include a `pull()` method to retrieve the full event payload, plus a `fetchRelatedObject()` method (if applicable) to retrieve the event's related object.
  - We're actively experimenting with the developer experience of this change, so please let us know how you like it!
* [#717](https://github.com/stripe/stripe-node-next/pull/717) Add v2 accounts support for Dec release
* [#716](https://github.com/stripe/stripe-node-next/pull/716) Update generated code for next
  Release specs are identical.
* [#715](https://github.com/stripe/stripe-node-next/pull/715) Bring back use of PreviewVersion for v2 APIs
* [#714](https://github.com/stripe/stripe-node-next/pull/714) Add example for /v2/core/accounts APIs
* [#713](https://github.com/stripe/stripe-node-next/pull/713) Update generated code for next
  Release specs are identical.

## 0.58.0 - 2024-11-19
* All requests made will now target the API version `2024-11-20.acacia`
* [#712](https://github.com/stripe/stripe-node-next/pull/712) Updates to pagination of list responses
  * The `next_page` and `previous_page` properties are no longer returned in the list responses. If you have cached these from a previous response, they will no longer work. To fetch the next or previous page, use the new `next_page_url` or `previous_page_url` property instead, or switch to using the auto pagination feature in the SDKs.
  If you have been auto pagination in the SDKs already, then there is no change for you.
* [#709](https://github.com/stripe/stripe-node-next/pull/709) Fix V2 ApiList pagination properties
  * The type `V2.ApiList` is updated to replace `next_page` and `previous_page` with `next_page_url` and `previous_page_url`

## 0.57.0 - 2024-10-29

* All requests made will now target the API version `2024-10-28.acacia`
* Changes affecting Recipient Payout users
  * ⚠️ We added type and balance to v2 FinancialAccount, making it so that a FinancialAccount has a balance instead of containing potentially multiple types of balances.
    * `balance_type` is removed from multiple resources
    * `balances` is removed from `V2.FinancialAccounts` resource
  * Added methods `acknowledgeConfirmationOfPayee` and `initiateConfirmationOfPayee` on resource `V2.GbBankAccounts`
  * The V2 EventDestinations API has moved from `stripe.v2.eventDestinations` to `stripe.v2.core.eventDestinations`
  * The V2 Events API has moved from `stripe.v2.thinEvents` to `stripe.v2.core.events`
  * Removed the exported constant `PreviewVersion`. Use `ApiVersion` instead.
  * Removed method `parseSnapshotEvents`. Use `Webhook.constructEvent` instead.
  * The methods `fetchData()` and `fetchObject()` are removed from the thin events parsed from webhooks. You now need to call the `stripe.v2.core.events.retrieve()` method to fetch the event and then access the `data` property or `fetchRelatedObject()` method instead.

* Update generated code for Stripe API changes not related to Recipient Payouts
  * Add support for `kakao_pay`, `kr_card`, `naver_pay`, `payco`, and `samsung_pay` on `Checkout.Session.payment_method_options` and `Checkout.SessionCreateParams.payment_method_options`
  ...
  * Change `Refund.next_action.display_details` to be optional
  ...
  * Add support for `usage_threshold` on `Billing.AlertCreateParams` and `Billing.Alert`
  * Remove support for `filter` and `usage_threshold_config` on `Billing.AlertCreateParams` and `Billing.Alert`
...
## 0.56.0 - 2024-09-09
* [#673](https://github.com/stripe/stripe-node-next/pull/673) Update generated code for next
  * Release specs are identical.
* [#672](https://github.com/stripe/stripe-node-next/pull/672) Update generated code for next
  * Release specs are identical.
* [#671](https://github.com/stripe/stripe-node-next/pull/671) Update generated code for next
  * Release specs are identical.

## 0.55.0 - 2024-09-05
* [#670](https://github.com/stripe/stripe-node-next/pull/670) Update generated code for next
  * Release specs are identical.
* [#668](https://github.com/stripe/stripe-node-next/pull/668) Update generated code for next
...
## 0.54.0 - 2024-09-04
* [#669](https://github.com/stripe/stripe-node-next/pull/669) Generated Next SDK using 2024-09-04.preview-v2 snapshot
* [#667](https://github.com/stripe/stripe-node-next/pull/667) Update generated code for next
  * Release specs are identical.
* [#666](https://github.com/stripe/stripe-node-next/pull/666) Update generated code for next
  * Change `AccountLinkCreateParams.collection_options.fields` to be optional
* [#665](https://github.com/stripe/stripe-node-next/pull/665) Update generated code for next
  * Change `LineItem.description` to be optional
* [#664](https://github.com/stripe/stripe-node-next/pull/664) Update generated code for next
  * Add support for `status_details` on `TestHelpers.TestClock`
* [#663](https://github.com/stripe/stripe-node-next/pull/663) Update generated code for next
  * Release specs are identical.
* [#659](https://github.com/stripe/stripe-node-next/pull/659) No need for APIMode to be passed around from individual API methods
* [#662](https://github.com/stripe/stripe-node-next/pull/662) Update generated code for next
  * Change `Issuing.Card.shipping.address_validation` to be required
* [#661](https://github.com/stripe/stripe-node-next/pull/661) Update generated code for next
...
## 0.53.0 - 2024-08-22
* [#660](https://github.com/stripe/stripe-node-next/pull/660) Update generated code for next
  Release specs are identical.
* [#658](https://github.com/stripe/stripe-node-next/pull/658) Update generated code for next
  Release specs are identical.
* [#657](https://github.com/stripe/stripe-node-next/pull/657) Update generated code for next
  * Release specs are identical.
* [#656](https://github.com/stripe/stripe-node-next/pull/656) Update generated code for next
  * Release specs are identical.
* [#655](https://github.com/stripe/stripe-node-next/pull/655) Update generated code for next
  * Release specs are identical.
* [#654](https://github.com/stripe/stripe-node-next/pull/654) Update generated code for next
...
* [#653](https://github.com/stripe/stripe-node-next/pull/653) Update generated code for next
  * Release specs are identical.
* [#652](https://github.com/stripe/stripe-node-next/pull/652) Update generated code for next
  * Release specs are identical.
* [#651](https://github.com/stripe/stripe-node-next/pull/651) Update generated code for next
  * Release specs are identical.
* [#650](https://github.com/stripe/stripe-node-next/pull/650) Update generated code for next
  Release specs are identical.
* [#649](https://github.com/stripe/stripe-node-next/pull/649) Update generated code for next
...
* [#648](https://github.com/stripe/stripe-node-next/pull/648) Update generated code for next
...
* [#647](https://github.com/stripe/stripe-node-next/pull/647) Update generated code for next
...
* [#646](https://github.com/stripe/stripe-node-next/pull/646) Update generated code for next
  * Release specs are identical.
* [#645](https://github.com/stripe/stripe-node-next/pull/645) Update generated code for next
  * Release specs are identical.
* [#644](https://github.com/stripe/stripe-node-next/pull/644) Update generated code for next
  * Release specs are identical.
* [#643](https://github.com/stripe/stripe-node-next/pull/643) Update generated code for next
  * Release specs are identical.
* [#642](https://github.com/stripe/stripe-node-next/pull/642) Update generated code for next
  * Release specs are identical.
* [#641](https://github.com/stripe/stripe-node-next/pull/641) Update generated code for next
  * Add support for `authorization_code` on `Charge.payment_method_details.card`
* [#630](https://github.com/stripe/stripe-node-next/pull/630) Rename `V2.Event` to `ThinEvent`
  ⚠️ All references to `v2.Event` have been renamed to `ThinEvent`. To migrate, please replace all instances referring to the old Event name to the relevant ThinEvent equivalent. The function and usage of this API remains the same.
  * ⚠️ Renamed `Stripe.V2.Event` to `Stripe.ThinEvent`
  * ⚠️ Renamed `Stripe.parseEvent()` to `Stripe.parseThinEvent()`
  * ⚠️ Renamed `Stripe.events` to `Stripe.thinEvents`
* [#640](https://github.com/stripe/stripe-node-next/pull/640) Update generated code for next
...
* [#639](https://github.com/stripe/stripe-node-next/pull/639) Update generated code for next
...
* [#638](https://github.com/stripe/stripe-node-next/pull/638) Update generated code for next
  * Release specs are identical.
* [#637](https://github.com/stripe/stripe-node-next/pull/637) Update generated code for next
  * Add support for `type` on `Charge.payment_method_details.card_present.offline`, `ConfirmationToken.payment_method_preview.card.generated_from.payment_method_details.card_present.offline`, `ConfirmationToken.payment_method_preview.card_present.offline`, `PaymentMethod.card.generated_from.payment_method_details.card_present.offline`, `PaymentMethod.card_present.offline`, and `SetupAttempt.payment_method_details.card_present.offline`
* [#634](https://github.com/stripe/stripe-node-next/pull/634) Update generated code for next
  * Add support for `activate`, `archive`, `create`, `deactivate`, `list`, and `retrieve` methods on resource `Billing.Alert`
* [#633](https://github.com/stripe/stripe-node-next/pull/633) Update generated code for next
  * Release specs are identical.
* [#632](https://github.com/stripe/stripe-node-next/pull/632) Update generated code for next
...
* [#631](https://github.com/stripe/stripe-node-next/pull/631) Update generated code for next
...
* [#629](https://github.com/stripe/stripe-node-next/pull/629) Update generated code for next
  * Release specs are identical.

## 0.52.0 - 2024-07-22
* [#599](https://github.com/stripe/stripe-node-next/pull/599) Update generated code for next
...
* [#598](https://github.com/stripe/stripe-node-next/pull/598) Update generated code for next
  * Release specs are identical.
* [#597](https://github.com/stripe/stripe-node-next/pull/597) Update generated code for next
  * Add support for `buyer_id` on `Charge.payment_method_details.blik`
* [#596](https://github.com/stripe/stripe-node-next/pull/596) Update generated code for next
  * Add support for `case_type` on `Dispute.payment_method_details.card`
* [#595](https://github.com/stripe/stripe-node-next/pull/595) Update generated code for next
...
* [#594](https://github.com/stripe/stripe-node-next/pull/594) Update generated code for next
...
* [#593](https://github.com/stripe/stripe-node-next/pull/593) Update generated code for next
  * Release specs are identical.
* [#592](https://github.com/stripe/stripe-node-next/pull/592) Standardize default retry + timeout values and idempotency key generation

  - ⚠️ Adjusted default values for HTTP requests. You can use the old defaults by setting them explicitly. New values are:
    - max retries: `1` -> `2`
    - max timeout (seconds): `2` -> `5`
  - always generate an idempotency key for v2 `DELETE` requests
* [#591](https://github.com/stripe/stripe-node-next/pull/591) Update readme events documentation
* [#589](https://github.com/stripe/stripe-node-next/pull/589) Fix api_version in RequestEvent
* [#590](https://github.com/stripe/stripe-node-next/pull/590) Fix API request user agent for v2 requests
* [#588](https://github.com/stripe/stripe-node-next/pull/588) Update generated code for next
  * Add support for `customer` on `ConfirmationToken.payment_method_preview`
* [#587](https://github.com/stripe/stripe-node-next/pull/587) Update generated code for next
  * Release specs are identical.
* [#586](https://github.com/stripe/stripe-node-next/pull/586) Update generated code for next
  * Release specs are identical.
* [#585](https://github.com/stripe/stripe-node-next/pull/585) Update generated code for next
  * Add support for `payment_method_options` on `ConfirmationToken`
* [#584](https://github.com/stripe/stripe-node-next/pull/584) Update generated code for next
...
## 0.51.0 - 2024-07-09
* [#582](https://github.com/stripe/stripe-node-next/pull/582) Add webhook signature verification instructions to README
* [#583](https://github.com/stripe/stripe-node-next/pull/583) Update generated code for next
...
* [#581](https://github.com/stripe/stripe-node-next/pull/581) Update generated code for next
...
* [#580](https://github.com/stripe/stripe-node-next/pull/580) Update generated code for next
...
* [#578](https://github.com/stripe/stripe-node-next/pull/578) [BREAKING] require signature verification for v2 webhooks

  - ⚠️ add required `sigHeader` and `secret` arguments to `StripeClient.parseEvent`
* [#579](https://github.com/stripe/stripe-node-next/pull/579) Update generated code for next
  * Add support for `posted_at` on `Tax.TransactionCreateFromCalculationParams` and `Tax.Transaction`
* [#577](https://github.com/stripe/stripe-node-next/pull/577) Update generated code for next
  * Release specs are identical.
* [#576](https://github.com/stripe/stripe-node-next/pull/576) Update generated code for next
...
* [#575](https://github.com/stripe/stripe-node-next/pull/575) Update generated code for next
  * Release specs are identical.
* [#574](https://github.com/stripe/stripe-node-next/pull/574) Update generated code for next
  * Add support for `add_lines`, `remove_lines`, and `update_lines` methods on resource `Invoice`
* [#573](https://github.com/stripe/stripe-node-next/pull/573) Update generated code for next
  * Release specs are identical.
* [#572](https://github.com/stripe/stripe-node-next/pull/572) Update generated code for next
  * Release specs are identical.
* [#571](https://github.com/stripe/stripe-node-next/pull/571) Update generated code for next
...
* [#570](https://github.com/stripe/stripe-node-next/pull/570) Update generated code for next
  Release specs are identical.
* [#569](https://github.com/stripe/stripe-node-next/pull/569) Update generated code for next
  * Add support for `email_type` on `CreditNoteCreateParams`, `CreditNotePreviewLinesParams`, and `CreditNotePreviewParams`
  * Add support for new values `multibanco` and `twint` on enums `PaymentLink.payment_method_types[]`, `PaymentLinkCreateParams.payment_method_types[]`, and `PaymentLinkUpdateParams.payment_method_types[]`
* [#565](https://github.com/stripe/stripe-node-next/pull/565) add v2 semantics to idempotency key generation
* [#568](https://github.com/stripe/stripe-node-next/pull/568) Update generated code for next
  * Release specs are identical.
* [#567](https://github.com/stripe/stripe-node-next/pull/567) Update generated code for next
...
* [#566](https://github.com/stripe/stripe-node-next/pull/566) Update generated code for next
  * Add support for new value `zip` on enums `PaymentLink.payment_method_types[]`, `PaymentLinkCreateParams.payment_method_types[]`, and `PaymentLinkUpdateParams.payment_method_types[]`
* [#563](https://github.com/stripe/stripe-node-next/pull/563) Update generated code for next
...
* [#564](https://github.com/stripe/stripe-node-next/pull/564) [BREAKING] remove `Stripe` prefix from v2 errors

  ⚠️ V2 errors no longer have the word "Stripe" as a prefix.

  Affected errors are:

  - `StripeFinancialAccountNotOpenError` -> `FinancialAccountNotOpenError`
  - `StripeBlockedByStripeError` -> `BlockedByStripeError`
  - `StripeAlreadyCanceledError` -> `AlreadyCanceledError`
  - `StripeNotCancelableError` -> `NotCancelableError`
  - `StripeInsufficientFundsError` -> `InsufficientFundsError`
  - `StripeRecipientNotNotifiableError` -> `RecipientNotNotifiableError`
  - `StripeFeatureNotEnabledError` -> `FeatureNotEnabledError`
  - `StripeControlledByDashboardError` -> `ControlledByDashboardError`
  - `StripeInvalidPaymentMethodError` -> `InvalidPaymentMethodError`
  - `StripeQuotaExceededError` -> `QuotaExceededError`
* [#562](https://github.com/stripe/stripe-node-next/pull/562) Update generated code for next
  * Add support for `quantity_decimal` on `Issuing.AuthorizationCaptureParams.testHelpers.purchase_details.fuel`, `Issuing.Transaction.purchase_details.fuel`, `Issuing.TransactionCreateForceCaptureParams.testHelpers.purchase_details.fuel`, and `Issuing.TransactionCreateUnlinkedRefundParams.testHelpers.purchase_details.fuel`
...
* [#561](https://github.com/stripe/stripe-node-next/pull/561) Update generated code for next
  * Release specs are identical.
* [#560](https://github.com/stripe/stripe-node-next/pull/560) Update generated code for next
...
* [#559](https://github.com/stripe/stripe-node-next/pull/559) Update generated code for next
  * Release specs are identical.
* [#558](https://github.com/stripe/stripe-node-next/pull/558) Update generated code for next
  * Add support for `tax_id_collection` on `PaymentLinkUpdateParams`
* [#557](https://github.com/stripe/stripe-node-next/pull/557) Update generated code for next
  * Release specs are identical.
* [#556](https://github.com/stripe/stripe-node-next/pull/556) Update generated code for next
  Release specs are identical.
* [#555](https://github.com/stripe/stripe-node-next/pull/555) Update generated code for next
  * Release specs are identical.
* [#554](https://github.com/stripe/stripe-node-next/pull/554) Update generated code for next
  Release specs are identical.

## 0.50.0 - 2024-06-04
* [#537](https://github.com/stripe/stripe-node-next/pull/537) Update generated code for next
  Release specs are identical.
* [#536](https://github.com/stripe/stripe-node-next/pull/536) Update generated code for next
  * Remove support for resource `PlatformTaxFee`
* [#535](https://github.com/stripe/stripe-node-next/pull/535) Update generated code for next
...
* [#534](https://github.com/stripe/stripe-node-next/pull/534) Update generated code for next
  * Release specs are identical.
* [#533](https://github.com/stripe/stripe-node-next/pull/533) Update generated code for next
  * Add support for `generated_from` on `ConfirmationToken.payment_method_preview.card` and `PaymentMethod.card`
* [#532](https://github.com/stripe/stripe-node-next/pull/532) Update generated code for next
...
* [#531](https://github.com/stripe/stripe-node-next/pull/531) Update generated code for next
  * Release specs are identical.
* [#530](https://github.com/stripe/stripe-node-next/pull/530) Update generated code for next
...
* [#529](https://github.com/stripe/stripe-node-next/pull/529) Update generated code for next
  * Release specs are identical.
* [#528](https://github.com/stripe/stripe-node-next/pull/528) Update generated code for next
  * Release specs are identical.

## 0.49.0 - 2024-05-28
* [#527](https://github.com/stripe/stripe-node-next/pull/527) Update generated code for next
  Release specs are identical.
* [#526](https://github.com/stripe/stripe-node-next/pull/526) Update generated code for next
  * Release specs are identical.
* [#525](https://github.com/stripe/stripe-node-next/pull/525) Update generated code for next
...
* [#524](https://github.com/stripe/stripe-node-next/pull/524) Update generated code for next
...
* [#523](https://github.com/stripe/stripe-node-next/pull/523) Update generated code for next
...
* [#522](https://github.com/stripe/stripe-node-next/pull/522) Update generated code for next
  * Add support for `payment_method_remove` on `Checkout.Session.saved_payment_method_options`
* [#521](https://github.com/stripe/stripe-node-next/pull/521) Update generated code for next
  * Release specs are identical.
* [#520](https://github.com/stripe/stripe-node-next/pull/520) Update generated code for next
  * Release specs are identical.
* [#519](https://github.com/stripe/stripe-node-next/pull/519) Update generated code for next
...
* [#518](https://github.com/stripe/stripe-node-next/pull/518) Update generated code for next
  * Release specs are identical.
* [#517](https://github.com/stripe/stripe-node-next/pull/517) Update generated code for next
...
* [#516](https://github.com/stripe/stripe-node-next/pull/516) Update generated code for next
  * Release specs are identical.
* [#515](https://github.com/stripe/stripe-node-next/pull/515) Update generated code for next
...
* [#514](https://github.com/stripe/stripe-node-next/pull/514) Update generated code for next
  * Release specs are identical.
* [#513](https://github.com/stripe/stripe-node-next/pull/513) Update generated code for next
  * Add support for `loss_reason` on `Issuing.Dispute`
* [#512](https://github.com/stripe/stripe-node-next/pull/512) Update generated code for next
...
* [#511](https://github.com/stripe/stripe-node-next/pull/511) Update generated code for next
  * Release specs are identical.
* [#510](https://github.com/stripe/stripe-node-next/pull/510) Update generated code for next
...
* [#509](https://github.com/stripe/stripe-node-next/pull/509) Update generated code for next
  * Remove support for `kr_market` on `Charge.payment_method_details`, `ConfirmationToken.payment_method_preview`, `ConfirmationTokenCreateParams.testHelpers.payment_method_data`, `Mandate.payment_method_details`, `PaymentIntent.payment_method_options`, `PaymentIntentConfirmParams.payment_method_data`, `PaymentIntentConfirmParams.payment_method_options`, `PaymentIntentCreateParams.payment_method_data`, `PaymentIntentCreateParams.payment_method_options`, `PaymentIntentUpdateParams.payment_method_data`, `PaymentIntentUpdateParams.payment_method_options`, `PaymentMethodCreateParams`, `PaymentMethodUpdateParams`, `PaymentMethod`, `SetupAttempt.payment_method_details`, `SetupIntentConfirmParams.payment_method_data`, `SetupIntentCreateParams.payment_method_data`, and `SetupIntentUpdateParams.payment_method_data`
  * Remove support for value `kr_market` from enums `ConfirmationTokenCreateParams.testHelpers.payment_method_data.type`, `PaymentIntentConfirmParams.payment_method_data.type`, `PaymentIntentCreateParams.payment_method_data.type`, `PaymentIntentUpdateParams.payment_method_data.type`, `SetupIntentConfirmParams.payment_method_data.type`, `SetupIntentCreateParams.payment_method_data.type`, and `SetupIntentUpdateParams.payment_method_data.type`
  * Remove support for value `kr_market` from enums `ConfirmationToken.payment_method_preview.type` and `PaymentMethod.type`
  * Remove support for value `kr_market` from enums `CustomerListPaymentMethodsParams.type`, `PaymentMethodCreateParams.type`, and `PaymentMethodListParams.type`
* [#508](https://github.com/stripe/stripe-node-next/pull/508) Update generated code for next
  Release specs are identical.
* [#507](https://github.com/stripe/stripe-node-next/pull/507) Update generated code for next
  * Add support for `archived` and `lookup_key` on `Entitlements.FeatureListParams`
* [#506](https://github.com/stripe/stripe-node-next/pull/506) Update generated code for next
  * Change `Treasury.OutboundPayment.tracking_details` and `Treasury.OutboundTransfer.tracking_details` to be required
* [#505](https://github.com/stripe/stripe-node-next/pull/505) Update generated code for next
  * Release specs are identical.
* [#504](https://github.com/stripe/stripe-node-next/pull/504) Update generated code for next
...
* [#503](https://github.com/stripe/stripe-node-next/pull/503) Update generated code for next
  * Change `FinancialConnections.SessionCreateParams.filters.countries` to be optional
* [#502](https://github.com/stripe/stripe-node-next/pull/502) Update generated code for next
  * Remove support for `pending_invoice_items_behavior` on `SubscriptionCreateParams`
* [#501](https://github.com/stripe/stripe-node-next/pull/501) Update generated code for next
  * Release specs are identical.
* [#500](https://github.com/stripe/stripe-node-next/pull/500) Update generated code for next
  Release specs are identical.
* [#499](https://github.com/stripe/stripe-node-next/pull/499) Update generated code for next
  * Release specs are identical.

## 0.48.0 - 2024-04-15
* [#445](https://github.com/stripe/stripe-node-next/pull/445) Update for the 2024-04-11 API version
* [#446](https://github.com/stripe/stripe-node-next/pull/446) Update generated code for next
...
* [#444](https://github.com/stripe/stripe-node-next/pull/444) Update generated code for next
  * Change `Billing.MeterEventCreateParams.timestamp` to be optional
* [#443](https://github.com/stripe/stripe-node-next/pull/443) Update generated code for next
...
* [#442](https://github.com/stripe/stripe-node-next/pull/442) Update generated code for next
...
* [#441](https://github.com/stripe/stripe-node-next/pull/441) Update generated code for next
...
* [#440](https://github.com/stripe/stripe-node-next/pull/440) Update generated code for next
...
* [#439](https://github.com/stripe/stripe-node-next/pull/439) Update generated code for next
...
* [#438](https://github.com/stripe/stripe-node-next/pull/438) Update generated code for next
  * Release specs are identical.
* [#437](https://github.com/stripe/stripe-node-next/pull/437) Update generated code for next
  * Release specs are identical.
* [#436](https://github.com/stripe/stripe-node-next/pull/436) Update generated code for next
...
* [#435](https://github.com/stripe/stripe-node-next/pull/435) Update generated code for next
...
* [#434](https://github.com/stripe/stripe-node-next/pull/434) Update generated code for next
...
* [#433](https://github.com/stripe/stripe-node-next/pull/433) Update generated code for next
  ...
  * Remove support for `rendering_options` on `InvoiceCreateParams`, `InvoiceUpdateParams`, and `Invoice`
  * Add support for `marketing_features` on `ProductCreateParams`, `ProductUpdateParams`, and `Product`
  * Remove support for `features` on `ProductCreateParams`, `ProductUpdateParams`, and `Product`
  * Add support for new value `2024-04-10` on enum `WebhookEndpointCreateParams.api_version`
* [#432](https://github.com/stripe/stripe-node-next/pull/432) Update generated code for next
...
* [#431](https://github.com/stripe/stripe-node-next/pull/431) Update generated code for next
...
* [#430](https://github.com/stripe/stripe-node-next/pull/430) Update generated code for next
  * Add support for `promotion_code` on `QuoteCreateParams.discounts[]`, `QuoteCreateParams.line_items[].discounts[]`, `QuoteUpdateParams.discounts[]`, and `QuoteUpdateParams.line_items[].discounts[]`
* [#429](https://github.com/stripe/stripe-node-next/pull/429) Update generated code for next
  * Release specs are identical.
* [#428](https://github.com/stripe/stripe-node-next/pull/428) Update generated code for next
...
* [#427](https://github.com/stripe/stripe-node-next/pull/427) Update generated code for next
  Release specs are identical.
* [#426](https://github.com/stripe/stripe-node-next/pull/426) Update generated code for next
...
* [#425](https://github.com/stripe/stripe-node-next/pull/425) Update generated code for next
...
* [#424](https://github.com/stripe/stripe-node-next/pull/424) Update generated code for next
...
* [#423](https://github.com/stripe/stripe-node-next/pull/423) Update generated code for next
  * Remove support for `subscription_pause` on `BillingPortal.Configuration.features`, `BillingPortal.ConfigurationCreateParams.features`, and `BillingPortal.ConfigurationUpdateParams.features`
  ...
  * Add support for `promotion_code` on `InvoiceCreateParams.discounts[]`, `InvoiceItemCreateParams.discounts[]`, `InvoiceItemUpdateParams.discounts[]`, and `InvoiceUpdateParams.discounts[]`
...
* [#422](https://github.com/stripe/stripe-node-next/pull/422) Update generated code for next
  * Release specs are identical.
* [#421](https://github.com/stripe/stripe-node-next/pull/421) Update generated code for next
  * Release specs are identical.
* [#420](https://github.com/stripe/stripe-node-next/pull/420) Update generated code for next
...
* [#419](https://github.com/stripe/stripe-node-next/pull/419) Update generated code for next
  * Release specs are identical.
* [#418](https://github.com/stripe/stripe-node-next/pull/418) Update generated code for next
...
* [#417](https://github.com/stripe/stripe-node-next/pull/417) Update generated code for next
  * Release specs are identical.

## 0.47.0 - 2024-03-20
* [#405](https://github.com/stripe/stripe-node-next/pull/405) Update generated code for next
  Release specs are identical.
* [#404](https://github.com/stripe/stripe-node-next/pull/404) Update generated code for next
  * Add support for `payment_reference` on `Charge.payment_method_details.us_bank_account`
* [#403](https://github.com/stripe/stripe-node-next/pull/403) Update generated code for next
  * Add support for new resource `Forwarding.Request`
  * Add support for `create`, `list`, and `retrieve` methods on resource `Request`
* [#402](https://github.com/stripe/stripe-node-next/pull/402) Update generated code for next
...
* [#401](https://github.com/stripe/stripe-node-next/pull/401) Update generated code for next
  * Release specs are identical.
* [#400](https://github.com/stripe/stripe-node-next/pull/400) Update generated code for next
...
* [#399](https://github.com/stripe/stripe-node-next/pull/399) Update generated code for next
...
## 0.46.0 - 2024-03-18
* [#398](https://github.com/stripe/stripe-node-next/pull/398) Update generated code for next
  Release specs are identical.
* [#397](https://github.com/stripe/stripe-node-next/pull/397) Update generated code for next
  Release specs are identical.
* [#396](https://github.com/stripe/stripe-node-next/pull/396) Update generated code for next
...
* [#395](https://github.com/stripe/stripe-node-next/pull/395) Update generated code for next
  * Add support for `second_line` on `Issuing.PhysicalBundle.features`
* [#394](https://github.com/stripe/stripe-node-next/pull/394) Update generated code for next
  * Release specs are identical.
* [#393](https://github.com/stripe/stripe-node-next/pull/393) Update generated code for next
...
* [#392](https://github.com/stripe/stripe-node-next/pull/392) Update generated code for next
  Release specs are identical.
* [#391](https://github.com/stripe/stripe-node-next/pull/391) Update generated code for next
...
* [#390](https://github.com/stripe/stripe-node-next/pull/390) Update generated code for next
  * Add support for `documents` on `AccountSession.components`
* [#389](https://github.com/stripe/stripe-node-next/pull/389) Update generated code for next
...
* [#388](https://github.com/stripe/stripe-node-next/pull/388) Update generated code for next
  * Release specs are identical.
* [#387](https://github.com/stripe/stripe-node-next/pull/387) Update generated code for next
  * Release specs are identical.
* [#386](https://github.com/stripe/stripe-node-next/pull/386) Update generated code for next
  * Add support for `documents` on `AccountSessionCreateParams.components`
* [#385](https://github.com/stripe/stripe-node-next/pull/385) Update generated code for next
  * Release specs are identical.
* [#384](https://github.com/stripe/stripe-node-next/pull/384) Update generated code for next
  * Add support for `created` on `CreditNoteListParams`
* [#383](https://github.com/stripe/stripe-node-next/pull/383) Update generated code for next
...
* [#382](https://github.com/stripe/stripe-node-next/pull/382) Update generated code for next
  * Release specs are identical.
* [#381](https://github.com/stripe/stripe-node-next/pull/381) Update generated code for next
  Release specs are identical.
* [#380](https://github.com/stripe/stripe-node-next/pull/380) Update generated code for next
  * Add support for `payment_method` on `TokenCreateParams.bank_account`
* [#379](https://github.com/stripe/stripe-node-next/pull/379) Update generated code for next
  * Release specs are identical.
* [#378](https://github.com/stripe/stripe-node-next/pull/378) Update generated code for next
  * Release specs are identical.
* [#377](https://github.com/stripe/stripe-node-next/pull/377) Update generated code for next
  * Release specs are identical.
* [#376](https://github.com/stripe/stripe-node-next/pull/376) Update generated code for next
...
* [#375](https://github.com/stripe/stripe-node-next/pull/375) Update generated code for next
...
* [#374](https://github.com/stripe/stripe-node-next/pull/374) Update generated code for next
  * Release specs are identical.
* [#373](https://github.com/stripe/stripe-node-next/pull/373) Update generated code for next
...
* [#372](https://github.com/stripe/stripe-node-next/pull/372) Update generated code for next
  * Add support for `number` on `InvoiceCreateParams` and `InvoiceUpdateParams`
* [#371](https://github.com/stripe/stripe-node-next/pull/371) Update generated code for next
  Release specs are identical.
* [#370](https://github.com/stripe/stripe-node-next/pull/370) Merge upstream

## 0.45.0 - 2024-02-20
* [#363](https://github.com/stripe/stripe-node-next/pull/363) Update generated code for next
  * Release specs are identical.
* [#341](https://github.com/stripe/stripe-node-next/pull/341) Type-based errors
* [#362](https://github.com/stripe/stripe-node-next/pull/362) Update generated code for next
  * Release specs are identical.
* [#361](https://github.com/stripe/stripe-node-next/pull/361) Update generated code for next
...
* [#360](https://github.com/stripe/stripe-node-next/pull/360) Update generated code for next
  * Release specs are identical.
* [#359](https://github.com/stripe/stripe-node-next/pull/359) Update generated code for next
  * Change `PaymentMethod.card.display_brand` to be required
* [#358](https://github.com/stripe/stripe-node-next/pull/358) Update generated code for next
...
* [#357](https://github.com/stripe/stripe-node-next/pull/357) Update generated code for next
  * Release specs are identical.
* [#356](https://github.com/stripe/stripe-node-next/pull/356) Update generated code for next
  * Add support for `networks` on `Card`, `PaymentMethodCreateParams.card[0]`, `PaymentMethodUpdateParams.card`, and `TokenCreateParams.card[0]`
  * Add support for `display_brand` on `PaymentMethod.card`
* [#355](https://github.com/stripe/stripe-node-next/pull/355) Update generated code for next
  * Release specs are identical.
* [#354](https://github.com/stripe/stripe-node-next/pull/354) Update generated code for next
  * Release specs are identical.
* [#353](https://github.com/stripe/stripe-node-next/pull/353) Update generated code for next
...
* [#352](https://github.com/stripe/stripe-node-next/pull/352) Update generated code for next
  * Release specs are identical.
* [#351](https://github.com/stripe/stripe-node-next/pull/351) Update generated code for next
  * Add support for `mobile_auth_url` on `PaymentIntent.next_action.swish_handle_redirect_or_display_qr_code`
* [#350](https://github.com/stripe/stripe-node-next/pull/350) Update generated code for next
  * Remove support for `mobile_auth_url` on `PaymentIntent.next_action.swish_handle_redirect_or_display_qr_code`
* [#349](https://github.com/stripe/stripe-node-next/pull/349) Update generated code for next
...
* [#348](https://github.com/stripe/stripe-node-next/pull/348) Update generated code for next
...
* [#347](https://github.com/stripe/stripe-node-next/pull/347) Update generated code for next
...
* [#346](https://github.com/stripe/stripe-node-next/pull/346) Update generated code for next
  * Release specs are identical.
* [#345](https://github.com/stripe/stripe-node-next/pull/345) Update generated code for next
  * Release specs are identical.
* [#344](https://github.com/stripe/stripe-node-next/pull/344) Update generated code for next
...
* [#343](https://github.com/stripe/stripe-node-next/pull/343) Update generated code for next
  * Add support for `swish_payments` on `Account.capabilities`, `AccountCreateParams.capabilities`, and `AccountUpdateParams.capabilities`
  * Add support for `swish` on `Charge.payment_method_details`, `PaymentIntent.payment_method_options`, `PaymentIntentConfirmParams.payment_method_data`, `PaymentIntentConfirmParams.payment_method_options`, `PaymentIntentCreateParams.payment_method_data`, `PaymentIntentCreateParams.payment_method_options`, `PaymentIntentUpdateParams.payment_method_data`, `PaymentIntentUpdateParams.payment_method_options`, `PaymentMethodCreateParams`, `PaymentMethod`, `Refund.destination_details`, `SetupIntentConfirmParams.payment_method_data`, `SetupIntentCreateParams.payment_method_data`, and `SetupIntentUpdateParams.payment_method_data`
  * Add support for new value `swish` on enums `CustomerListPaymentMethodsParams.type`, `PaymentMethodCreateParams.type`, and `PaymentMethodListParams.type`
  * Add support for new value `swish` on enums `PaymentIntentConfirmParams.payment_method_data.type`, `PaymentIntentCreateParams.payment_method_data.type`, `PaymentIntentUpdateParams.payment_method_data.type`, `SetupIntentConfirmParams.payment_method_data.type`, `SetupIntentCreateParams.payment_method_data.type`, and `SetupIntentUpdateParams.payment_method_data.type`
...
* [#342](https://github.com/stripe/stripe-node-next/pull/342) Update generated code for next
...
* [#340](https://github.com/stripe/stripe-node-next/pull/340) Update generated code for next
  * Release specs are identical.
* [#339](https://github.com/stripe/stripe-node-next/pull/339) Update generated code for next
  * Change type of `Terminal.Reader.status` from `string` to `enum('offline'|'online')`
* [#338](https://github.com/stripe/stripe-node-next/pull/338) Update generated code for next
  * Release specs are identical.
* [#337](https://github.com/stripe/stripe-node-next/pull/337) Update generated code for next
  * Release specs are identical.
* [#336](https://github.com/stripe/stripe-node-next/pull/336) Update generated code for next
  * Add support for `swish` on `Checkout.Session.payment_method_options` and `Checkout.SessionCreateParams.payment_method_options`
  * Add support for new value `swish` on enum `Checkout.SessionCreateParams.payment_method_types[]`
  * Add support for new value `swish` on enums `PaymentLink.payment_method_types[]`, `PaymentLinkCreateParams.payment_method_types[]`, and `PaymentLinkUpdateParams.payment_method_types[]`
* [#335](https://github.com/stripe/stripe-node-next/pull/335) Update generated code for next
  * Add support for `jurisdiction_level` on `TaxRate`
* [#334](https://github.com/stripe/stripe-node-next/pull/334) Update generated code for next
  * Release specs are identical.

## 0.44.0 - 2023-12-11
* [#262](https://github.com/stripe/stripe-node-next/pull/262) Update generated code for next
  Release specs are identical.
* [#261](https://github.com/stripe/stripe-node-next/pull/261) Update generated code for next
  Release specs are identical.
* [#260](https://github.com/stripe/stripe-node-next/pull/260) Update generated code for next
  * Remove support for `id_bank_transfer`, `multibanco`, `netbanking`, `pay_by_bank`, and `upi` on `PaymentMethodConfiguration`
* [#259](https://github.com/stripe/stripe-node-next/pull/259) Update generated code for next
...
## 0.43.0 - 2023-12-07
* [#258](https://github.com/stripe/stripe-node-next/pull/258) Update generated code for next
...
* [#257](https://github.com/stripe/stripe-node-next/pull/257) Update generated code for next
...
* [#256](https://github.com/stripe/stripe-node-next/pull/256) Update generated code for next
...
* [#255](https://github.com/stripe/stripe-node-next/pull/255) Update generated code for next
  * Remove support for value `various` from enum `Climate.Supplier.removal_pathway`
* [#254](https://github.com/stripe/stripe-node-next/pull/254) Update generated code for next
...
* [#253](https://github.com/stripe/stripe-node-next/pull/253) Update generated code for next
...
* [#252](https://github.com/stripe/stripe-node-next/pull/252) Update generated code for next
...
* [#251](https://github.com/stripe/stripe-node-next/pull/251) Update generated code for next
  * Add support for `inactive_message` and `restrictions` on `PaymentLinkCreateParams`, `PaymentLinkUpdateParams`, and `PaymentLink`
* [#250](https://github.com/stripe/stripe-node-next/pull/250) Update generated code for next
  * Change `Climate.Product.metric_tons_available` to be required
* [#249](https://github.com/stripe/stripe-node-next/pull/249) Update generated code for next
...
* [#248](https://github.com/stripe/stripe-node-next/pull/248) Update generated code for next
...
* [#247](https://github.com/stripe/stripe-node-next/pull/247) Update generated code for next
...
* [#246](https://github.com/stripe/stripe-node-next/pull/246) Update generated code for next
  * Release specs are identical.
* [#245](https://github.com/stripe/stripe-node-next/pull/245) Update generated code for next
  * Release specs are identical.
* [#244](https://github.com/stripe/stripe-node-next/pull/244) Update generated code for next
...
* [#243](https://github.com/stripe/stripe-node-next/pull/243) Update generated code for next
...
* [#242](https://github.com/stripe/stripe-node-next/pull/242) Update generated code for next
...
* [#241](https://github.com/stripe/stripe-node-next/pull/241) Update generated code for next
  * Release specs are identical.
* [#240](https://github.com/stripe/stripe-node-next/pull/240) Update generated code for next
  * Release specs are identical.
* [#239](https://github.com/stripe/stripe-node-next/pull/239) Update generated code for next
  * Release specs are identical.
* [#238](https://github.com/stripe/stripe-node-next/pull/238) Update generated code for next
...
* [#237](https://github.com/stripe/stripe-node-next/pull/237) Update generated code for next
...
* [#236](https://github.com/stripe/stripe-node-next/pull/236) Update generated code for next
  * Release specs are identical.
* [#235](https://github.com/stripe/stripe-node-next/pull/235) Update generated code for next
  * Release specs are identical.
* [#234](https://github.com/stripe/stripe-node-next/pull/234) Update generated code for next
  * Release specs are identical.
* [#233](https://github.com/stripe/stripe-node-next/pull/233) Update generated code for next
  * Add support for `offline` on `Charge.payment_method_details.card_present`
* [#232](https://github.com/stripe/stripe-node-next/pull/232) Update generated code for next
  Release specs are identical.
* [#231](https://github.com/stripe/stripe-node-next/pull/231) Update generated code for next
  * Add support for `status` on `Checkout.SessionListParams`
* [#230](https://github.com/stripe/stripe-node-next/pull/230) Update generated code for next
  ...
  * Change type of `SubscriptionScheduleCreateParams.start_date[0]`, `SubscriptionScheduleUpdateParams.phases[].end_date[0]`, `SubscriptionScheduleUpdateParams.phases[].start_date[0]`, and `SubscriptionScheduleUpdateParams.phases[].trial_end[0]` from `longInteger` to `DateTime`
* [#229](https://github.com/stripe/stripe-node-next/pull/229) Update generated code for next
...
## 0.42.0 - 2023-11-06
* [#215](https://github.com/stripe/stripe-node-next/pull/215) Update generated code for next
  Release specs are identical.
* [#214](https://github.com/stripe/stripe-node-next/pull/214) Update generated code for next
  * Release specs are identical.
* [#213](https://github.com/stripe/stripe-node-next/pull/213) Update generated code for next
...
* [#212](https://github.com/stripe/stripe-node-next/pull/212) Update generated code for next
  * Release specs are identical.
* [#211](https://github.com/stripe/stripe-node-next/pull/211) Update generated code for next
...
* [#210](https://github.com/stripe/stripe-node-next/pull/210) Update generated code for next
  * Release specs are identical.
* [#209](https://github.com/stripe/stripe-node-next/pull/209) Update generated code for next
...
* [#208](https://github.com/stripe/stripe-node-next/pull/208) Update generated code for next
  * Release specs are identical.
* [#207](https://github.com/stripe/stripe-node-next/pull/207) Update generated code for next
...
* [#206](https://github.com/stripe/stripe-node-next/pull/206) Update generated code for next
...
* [#205](https://github.com/stripe/stripe-node-next/pull/205) Update generated code for next
  * Add support for `revolut_pay_payments` on `Account.capabilities`, `AccountCreateParams.capabilities`, and `AccountUpdateParams.capabilities`
  ...
  * Add support for new value `revolut_pay` on enums `Checkout.SessionCreateParams.payment_method_types[]`, `CustomerListPaymentMethodsParams.type`, `PaymentMethodCreateParams.type`, and `PaymentMethodListParams.type`
  * Add support for new value `revolut_pay` on enums `PaymentIntentConfirmParams.payment_method_data.type`, `PaymentIntentCreateParams.payment_method_data.type`, `PaymentIntentUpdateParams.payment_method_data.type`, `SetupIntentConfirmParams.payment_method_data.type`, `SetupIntentCreateParams.payment_method_data.type`, and `SetupIntentUpdateParams.payment_method_data.type`
  * Add support for new value `revolut_pay` on enum `PaymentMethod.type`
* [#204](https://github.com/stripe/stripe-node-next/pull/204) Update generated code for next
  * Add support for new resource `Tax.Registration`
  * Add support for `create`, `list`, and `update` methods on resource `Registration`
* [#203](https://github.com/stripe/stripe-node-next/pull/203) Update generated code for next
...
* [#202](https://github.com/stripe/stripe-node-next/pull/202) Update generated code for next
  * Release specs are identical.
* [#201](https://github.com/stripe/stripe-node-next/pull/201) Update generated code for next
  * Release specs are identical.
* [#200](https://github.com/stripe/stripe-node-next/pull/200) Update generated code for next
...
* [#199](https://github.com/stripe/stripe-node-next/pull/199) Update generated code for next
...
* [#198](https://github.com/stripe/stripe-node-next/pull/198) Update generated code for next
  * Release specs are identical.
* [#197](https://github.com/stripe/stripe-node-next/pull/197) Update generated code for next
  Release specs are identical.
* [#196](https://github.com/stripe/stripe-node-next/pull/196) Update generated code for next
  * Change `Issuing.Cardholder.individual.card_issuing` to be optional
* [#195](https://github.com/stripe/stripe-node-next/pull/195) Update generated code for next
  * Release specs are identical.
* [#194](https://github.com/stripe/stripe-node-next/pull/194) Update generated code for next
  * Release specs are identical.
* [#193](https://github.com/stripe/stripe-node-next/pull/193) Merge upstream master
* [#192](https://github.com/stripe/stripe-node-next/pull/192) Update generated code for next
  Release specs are identical.
* [#191](https://github.com/stripe/stripe-node-next/pull/191) Update generated code for next
  * Remove support for `request_incremental_authorization` on `PaymentIntentConfirmParams.payment_method_options.card_present`, `PaymentIntentCreateParams.payment_method_options.card_present`, and `PaymentIntentUpdateParams.payment_method_options.card_present`
* [#190](https://github.com/stripe/stripe-node-next/pull/190) Update generated code for next
  * Release specs are identical.
* [#189](https://github.com/stripe/stripe-node-next/pull/189) Update generated code for next
...
* [#188](https://github.com/stripe/stripe-node-next/pull/188) Update generated code for next
  * Change `Checkout.Session.client_secret` and `Checkout.Session.ui_mode` to be required
* [#187](https://github.com/stripe/stripe-node-next/pull/187) Update generated code for next
...
* [#186](https://github.com/stripe/stripe-node-next/pull/186) Update generated code for next
...
* [#186](https://github.com/stripe/stripe-node-next/pull/186) Update generated code for next
  * Add support for new values `issuing_token.created` and `issuing_token.updated` on enum `Event.type`
  * Add support for new values `issuing_token.created` and `issuing_token.updated` on enums `WebhookEndpointCreateParams.enabled_events[]` and `WebhookEndpointUpdateParams.enabled_events[]`
* [#185](https://github.com/stripe/stripe-node-next/pull/185) Merge upstream
* [#184](https://github.com/stripe/stripe-node-next/pull/184) Update generated code for next
...
* [#183](https://github.com/stripe/stripe-node-next/pull/183) Make all events typed
* [#182](https://github.com/stripe/stripe-node-next/pull/182) Update generated code for next
  Release specs are identical.
* [#181](https://github.com/stripe/stripe-node-next/pull/181) Update generated code for next
...
* [#180](https://github.com/stripe/stripe-node-next/pull/180) Update generated code for next
  * Release specs are identical.
* [#179](https://github.com/stripe/stripe-node-next/pull/179) Update generated code for next
  * Add support for `postal_code` on `Issuing.Authorization.verification_data`
* [#178](https://github.com/stripe/stripe-node-next/pull/178) Update generated code for next
...
* [#177](https://github.com/stripe/stripe-node-next/pull/177) Update generated code for next
  * Release specs are identical.
* [#176](https://github.com/stripe/stripe-node-next/pull/176) Update generated code for next
  * Release specs are identical.
* [#175](https://github.com/stripe/stripe-node-next/pull/175) Update generated code for next
  * Release specs are identical.
* [#174](https://github.com/stripe/stripe-node-next/pull/174) Update generated code for next
  * Remove support for resource `Margin`
  * Add support for `statement_descriptor_suffix` and `statement_descriptor` on `PaymentLink.payment_intent_data`, `PaymentLinkCreateParams.payment_intent_data`, and `PaymentLinkUpdateParams.payment_intent_data`
* [#173](https://github.com/stripe/stripe-node-next/pull/173) Update generated code for next
...
* [#172](https://github.com/stripe/stripe-node-next/pull/172) Update generated code for next
  * Release specs are identical.
* [#171](https://github.com/stripe/stripe-node-next/pull/171) Update generated code for next
  * Release specs are identical.
* [#170](https://github.com/stripe/stripe-node-next/pull/170) Update generated code for next
  * Add support for `authorization_code` on `Issuing.Authorization.request_history[]`
* [#169](https://github.com/stripe/stripe-node-next/pull/169) Update generated code for next
  * Release specs are identical.
* [#168](https://github.com/stripe/stripe-node-next/pull/168) Update generated code for next
  * Release specs are identical.

## 0.39.0 - 2023-09-15
* [#144](https://github.com/stripe/stripe-node-next/pull/144) Update generated code for next
  Release specs are identical.
* [#143](https://github.com/stripe/stripe-node-next/pull/143) Update generated code for next
  * Release specs are identical.
* [#142](https://github.com/stripe/stripe-node-next/pull/142) Update generated code for next
  * Release specs are identical.
* [#141](https://github.com/stripe/stripe-node-next/pull/141) Update generated code for next
...
* [#140](https://github.com/stripe/stripe-node-next/pull/140) Update generated code for next
...
* [#136](https://github.com/stripe/stripe-node-next/pull/136) Update generated code for next
  * Add support for new resources `AccountSession` and `PaymentMethodDomain`
  ...
  * Remove support for values `custom_account_update` and `custom_account_verification` from enum `AccountLinkCreateParams.type`
  * Remove support for `available_on` on `BalanceTransactionListParams`
  ...
  * Remove support for `coupon` and `trial_from_plan` on `Checkout.SessionCreateParams.subscription_data`
  * Remove support for value `card_present` from enums `CustomerListPaymentMethodsParams.type` and `PaymentMethodListParams.type`
  ...
  * Remove support for `blik` on `Mandate.payment_method_details`, `PaymentMethodUpdateParams`, `SetupAttempt.payment_method_details`, `SetupIntent.payment_method_options`, `SetupIntentConfirmParams.payment_method_options`, `SetupIntentCreateParams.payment_method_options`, and `SetupIntentUpdateParams.payment_method_options`
  ...
  * Remove support for `acss_debit`, `affirm`, `au_becs_debit`, `bacs_debit`, `cashapp`, `sepa_debit`, and `zip` on `PaymentMethodUpdateParams`
  * Remove support for `country` on `PaymentMethod.link`
  * Remove support for `recurring` on `PriceUpdateParams`
  * Add support for `features` on `ProductCreateParams`, `ProductUpdateParams`, and `Product`
  * Remove support for `attributes`, `caption`, and `deactivate_on` on `ProductCreateParams`, `ProductUpdateParams`, and `Product`
...
* [#138](https://github.com/stripe/stripe-node-next/pull/138) Merge upstream into master

## 0.38.0 - 2023-08-15
* [#137](https://github.com/stripe/stripe-node-next/pull/137) Temporarily revert V1 API version for next release
* [#135](https://github.com/stripe/stripe-node-next/pull/135) Update generated code for next
  * Add support for new value `2023-08-16` on enum `WebhookEndpointCreateParams.api_version`

## 0.37.0 - 2023-08-11
* [#134](https://github.com/stripe/stripe-node-next/pull/134) Update generated code for next
  ...
  * Add support for `process_config` on `Terminal.Reader.action.process_setup_intent` and `Terminal.ReaderProcessSetupIntentParams`
* [#133](https://github.com/stripe/stripe-node-next/pull/133) Update generated code for next
...
* [#132](https://github.com/stripe/stripe-node-next/pull/132) React to developer_message - message rename
* [#131](https://github.com/stripe/stripe-node-next/pull/131) Update generated code for next
...
* [#130](https://github.com/stripe/stripe-node-next/pull/130) Update generated code for next
...
## 0.36.0 - 2023-07-13
* [#129](https://github.com/stripe/stripe-node-next/pull/129) Update generated code for next
  Release specs are identical.
* [#128](https://github.com/stripe/stripe-node-next/pull/128) Update generated code for next
  Release specs are identical.

## 0.35.0 - 2023-07-13
* [#126](https://github.com/stripe/stripe-node-next/pull/126) Update generated code for next
...
* [#127](https://github.com/stripe/stripe-node-next/pull/127) Update README.md to fix typo
* [#125](https://github.com/stripe/stripe-node-next/pull/125) Update generated code for next
...
* [#124](https://github.com/stripe/stripe-node-next/pull/124) Update generated code for next
  * Add support for `on_behalf_of` on `Mandate`
* [#123](https://github.com/stripe/stripe-node-next/pull/123) Update generated code for next
  * Release specs are identical.
* [#122](https://github.com/stripe/stripe-node-next/pull/122) Update generated code for next
...
* [#121](https://github.com/stripe/stripe-node-next/pull/121) Merge upstream

## 0.34.0 - 2023-06-09
* [#115](https://github.com/stripe/stripe-node-next/pull/115) Update generated code for next
...
* [#119](https://github.com/stripe/stripe-node-next/pull/119) Fix stripeContext property name in typescript definitions
* [#118](https://github.com/stripe/stripe-node-next/pull/118) Fix naming of stripeContext setting
* [#117](https://github.com/stripe/stripe-node-next/pull/117) Merge upstream master
* [#116](https://github.com/stripe/stripe-node-next/pull/116) Rename V2ApiVersion -> PreviewVersion

## 0.33.0 - 2023-05-26
* [#114](https://github.com/stripe/stripe-node-next/pull/114) Update generated code for next
  * Add support for `description`, `iin`, and `issuer` on `PaymentMethod.card_present` and `PaymentMethod.interac_present`
* [#111](https://github.com/stripe/stripe-node-next/pull/111) Handle Date object params
* [#112](https://github.com/stripe/stripe-node-next/pull/112) Update generated code for next
...
* [#113](https://github.com/stripe/stripe-node-next/pull/113) Add a test validating that we encode null values correctly in v2 POST requests

## 0.32.0 - 2023-05-17
* [#110](https://github.com/stripe/stripe-node-next/pull/110) Update generated code for next
  Release specs are identical.
* [#109](https://github.com/stripe/stripe-node-next/pull/109) Update generated code for next
...
## 0.31.0 - 2023-05-15
* [#108](https://github.com/stripe/stripe-node-next/pull/108) Update generated code for next
...
## 0.30.0 - 2023-05-12
* [#106](https://github.com/stripe/stripe-node-next/pull/106) Update generated code for next
  Release specs are identical.

## 0.29.0 - 2023-05-12
* [#105](https://github.com/stripe/stripe-node-next/pull/105) Update generated code for next

## 0.28.0 - 2023-05-11
* [#104](https://github.com/stripe/stripe-node-next/pull/104) Update generated code for next

## 0.27.0 - 2023-05-09
* [#103](https://github.com/stripe/stripe-node-next/pull/103) Update generated code for next
  Release specs are identical.

## 0.26.0 - 2023-05-09
* [#102](https://github.com/stripe/stripe-node-next/pull/102) Update generated code for next
  Release specs are identical.

## 0.25.0 - 2023-05-08
* [#100](https://github.com/stripe/stripe-node-next/pull/100) Update generated code for next

## 0.24.0 - 2023-05-04
* [#99](https://github.com/stripe/stripe-node-next/pull/99) Update generated code for next
  * Add support for `link` on `Checkout.Session.payment_method_options` and `CheckoutSessionCreateParams.payment_method_options`

## 0.23.0 - 2023-05-01
* [#98](https://github.com/stripe/stripe-node-next/pull/98) Update generated code for next
...
* [#97](https://github.com/stripe/stripe-node-next/pull/97) Update README
* [#96](https://github.com/stripe/stripe-node-next/pull/96) Update generated code for next
  * Add support for `tax_breakdown` on `Tax.Calculation.shipping_cost` and `Tax.Transaction.shipping_cost`

## 0.22.0 - 2023-04-26
* [#95](https://github.com/stripe/stripe-node-next/pull/95) Update generated code for next
  * Add support for `billing_cycle_anchor` and `proration_behavior` on `CheckoutSessionCreateParams.subscription_data`

## 0.21.0 - 2023-04-25
* [#94](https://github.com/stripe/stripe-node-next/pull/94) Update generated code for next
  Release specs are identical.

## 0.20.0 - 2023-04-24
* [#93](https://github.com/stripe/stripe-node-next/pull/93) Update generated code for next
  * Add support for `terminal_id` on `Issuing.Authorization.merchant_data` and `Issuing.Transaction.merchant_data`
* [#92](https://github.com/stripe/stripe-node-next/pull/92) V2 Lists

## 0.19.0 - 2023-04-24
* [#90](https://github.com/stripe/stripe-node-next/pull/90) Update generated code for next
  * Add support for `metadata` on `PaymentIntentCaptureParams`
  * Add support for `checks` on `SetupAttempt.payment_method_details.card`
* [#91](https://github.com/stripe/stripe-node-next/pull/91) Encode arrays as repeated query string entries for v2

## 0.18.0 - 2023-04-20
* [#89](https://github.com/stripe/stripe-node-next/pull/89) Update generated code for next
  * Release specs are identical.

## 0.17.0 - 2023-04-19
* [#88](https://github.com/stripe/stripe-node-next/pull/88) Update generated code for next
  Release specs are identical.
* [#87](https://github.com/stripe/stripe-node-next/pull/87) Use Event generated type for typed events

## 0.16.0 - 2023-04-18
* [#86](https://github.com/stripe/stripe-node-next/pull/86) Update generated code for next
  Release specs are identical.

## 0.15.0 - 2023-04-17
* [#85](https://github.com/stripe/stripe-node-next/pull/85) Update generated code for next
  ...
  * Change type of `Identity.VerificationSession.options` from `GelatoVerificationSessionOptions` to `GelatoVerificationSessionOptions | null`
  * Change type of `Identity.VerificationSession.type` from `enum('document'|'id_number')` to `enum('document'|'id_number') | null`
* [#84](https://github.com/stripe/stripe-node-next/pull/84) Merge upstream
* [#83](https://github.com/stripe/stripe-node-next/pull/83) Update generated code for next
...
## 0.14.0 - 2023-04-11
* [#81](https://github.com/stripe/stripe-node-next/pull/81) Update generated code for next
...
* [#82](https://github.com/stripe/stripe-node-next/pull/82) React to event schema changes
* [#80](https://github.com/stripe/stripe-node-next/pull/80) Merge upstream master
* [#79](https://github.com/stripe/stripe-node-next/pull/79) Remove trailing newline

## 0.13.0 - 2023-04-06
* [#73](https://github.com/stripe/stripe-node-next/pull/73) V2 Autopagination
* [#76](https://github.com/stripe/stripe-node-next/pull/76) Support sending v2 api version
* [#71](https://github.com/stripe/stripe-node-next/pull/71) Allow omitting the client options parameter
* [#72](https://github.com/stripe/stripe-node-next/pull/72) Add a better error when api key is not provided

## 0.12.0 - 2023-03-30
* [#61](https://github.com/stripe/stripe-node-next/pull/61) Merge upstream
* [#58](https://github.com/stripe/stripe-node-next/pull/58) Update generated code for next (new)
  ...
  * Add support for new values `cashapp` and `link` on enum `CheckoutSessionCreateParams.payment_method_types[]`
  ...
  * Add support for new values `cashapp` and `link` on enums `PaymentLink.payment_method_types[]`, `PaymentLinkCreateParams.payment_method_types[]`, and `PaymentLinkUpdateParams.payment_method_types[]`
...
* [#59](https://github.com/stripe/stripe-node-next/pull/59) Fix Amount type
* [#53](https://github.com/stripe/stripe-node-next/pull/53) Support V2 Errors

## 0.11.0 - 2023-03-01
* [#51](https://github.com/stripe/stripe-node-next/pull/51) Send v2 request bodies as JSON

## 0.10.0 - 2023-03-01
* [#50](https://github.com/stripe/stripe-node-next/pull/50) API Updates
...
## 0.9.0 - 2023-02-28
* [#49](https://github.com/stripe/stripe-node-next/pull/49) Merge upstream/master
* [#47](https://github.com/stripe/stripe-node-next/pull/47) Replace remaining mentions of stripe-dev
* [#46](https://github.com/stripe/stripe-node-next/pull/46) Rename package to stripe/stripe
* [#43](https://github.com/stripe/stripe-node-next/pull/43) Merge remote-tracking branch 'upstream/master'
* [#44](https://github.com/stripe/stripe-node-next/pull/44) API Updates
...
* [#41](https://github.com/stripe/stripe-node-next/pull/41) API Updates
...
* [#3](https://github.com/stripe/stripe-node-next/pull/3) Refresh master from stripe-node/master
* [#16](https://github.com/stripe/stripe-node-next/pull/16) Add installation instructions to README
* [#2](https://github.com/stripe/stripe-node-next/pull/2) Add release to GitHub Packages
* [#40](https://github.com/stripe/stripe-node-next/pull/40) API Updates

* [#39](https://github.com/stripe/stripe-node-next/pull/39) Send content-digest for DELETE requests
* [#35](https://github.com/stripe/stripe-node-next/pull/35) React to authentication changes
* [#26](https://github.com/stripe/stripe-node-next/pull/26) Make Amount.amount a number
* [#25](https://github.com/stripe/stripe-node-next/pull/25) API Updates
  * Add support for `flow_data` on `BillingPortalSessionCreateParams`
  * Add support for `flow` on `BillingPortal.Session`
* [#24](https://github.com/stripe/stripe-node-next/pull/24) Support V2.Amount in node-next SDK
* [#17](https://github.com/stripe/stripe-node-next/pull/17) Add ability to provide X-Authz-Beta-Compartment header
* [#15](https://github.com/stripe/stripe-node-next/pull/15) API Updates
  Release specs are identical.
* [#13](https://github.com/stripe/stripe-node-next/pull/13) Merge upstream master
* [#10](https://github.com/stripe/stripe-node-next/pull/10) Merge upstream master
* [#9](https://github.com/stripe/stripe-node-next/pull/9) Add authenticator abstraction support
* [#6](https://github.com/stripe/stripe-node-next/pull/6) Merge upstream/master
* [#30](https://github.com/stripe/stripe-node-next/pull/30) API Updates
  * Change `CheckoutSessionCreateParams.cancel_url`, `CustomerListPaymentMethodsParams.type`, and `PaymentMethodListParams.type` to be optional
  * Change type of `Checkout.Session.cancel_url` from `string` to `string | null`
  * Add support for new value `merchant_default` on enums `CustomerCreateParams.cash_balance.settings.reconciliation_mode` and `CustomerUpdateParams.cash_balance.settings.reconciliation_mode`
  * Add support for `card_issuing` on `Issuing.Cardholder.individual`
* [#36](https://github.com/stripe/stripe-node-next/pull/36) API Updates
...
* [#27](https://github.com/stripe/stripe-node-next/pull/27) Don't sent {} body with GET requests
* [#29](https://github.com/stripe/stripe-node-next/pull/29) Add StripeEvent type and event definitions
* [#22](https://github.com/stripe/stripe-node-next/pull/22) Support request signing
* [#23](https://github.com/stripe/stripe-node-next/pull/23) API Updates
...
* [#21](https://github.com/stripe/stripe-node-next/pull/21) Add context property definitions, pin API version
* [#20](https://github.com/stripe/stripe-node-next/pull/20) API Updates
  Release specs are identical.
...
* [#44](https://github.com/stripe/stripe-node-next/pull/44) API Updates
## 0.6.0 - 2023-01-30
* [#38](https://github.com/stripe/stripe-node-next/pull/38) API Updates
## 0.5.0 - 2023-01-18
* [#35](https://github.com/stripe/stripe-node-next/pull/35) React to authentication changes
* [#29](https://github.com/stripe/stripe-node-next/pull/29) Add StripeEvent type and event definitions
* [#33](https://github.com/stripe/stripe-node-next/pull/33) Merge upstream master
* [#32](https://github.com/stripe/stripe-node-next/pull/32) Merge upstream master
* [#31](https://github.com/stripe/stripe-node-next/pull/31) Merge upstream master
* [#30](https://github.com/stripe/stripe-node-next/pull/30) API Updates
  * Change `CheckoutSessionCreateParams.cancel_url`, `CustomerListPaymentMethodsParams.type`, and `PaymentMethodListParams.type` to be optional
  * Change type of `Checkout.Session.cancel_url` from `string` to `string | null`
  * Add support for new value `merchant_default` on enums `CustomerCreateParams.cash_balance.settings.reconciliation_mode` and `CustomerUpdateParams.cash_balance.settings.reconciliation_mode`
  * Add support for `card_issuing` on `Issuing.Cardholder.individual`
* [#28](https://github.com/stripe/stripe-node-next/pull/28) Narrower README
...
* [#20](https://github.com/stripe/stripe-node-next/pull/20) API Updates
  Release specs are identical.
* [#19](https://github.com/stripe/stripe-node-next/pull/19) Merge upstream master
* [#18](https://github.com/stripe/stripe-node-next/pull/18) Use @stripe-dev/stripe as a module name for -next
* [#17](https://github.com/stripe/stripe-node-next/pull/17) Add ability to provide X-Authz-Beta-Compartment header
* [#16](https://github.com/stripe/stripe-node-next/pull/16) Add installation instructions to README
...
## 0.0.2 - 2022-11-29
* [#14](https://github.com/stripe/stripe-node-next/pull/14) Fix createTemporaryV2ApiKeyAuthenticator
* [#13](https://github.com/stripe/stripe-node-next/pull/13) Merge upstream master
* [#9](https://github.com/stripe/stripe-node-next/pull/9) Add authenticator abstraction support
* [#10](https://github.com/stripe/stripe-node-next/pull/10) Merge upstream master
* [#8](https://github.com/stripe/stripe-node-next/pull/8) Add support for apiMode method spec and JSON encode bodies for V2
* [#7](https://github.com/stripe/stripe-node-next/pull/7) Update master from upstream
* [#6](https://github.com/stripe/stripe-node-next/pull/6) Merge upstream/master
* [#5](https://github.com/stripe/stripe-node-next/pull/5) Reset version to 0.0.1
* [#3](https://github.com/stripe/stripe-node-next/pull/3) Refresh master from stripe-node/master
* [#2](https://github.com/stripe/stripe-node-next/pull/2) Add release to GitHub Packages
* [#1](https://github.com/stripe/stripe-node-next/pull/1) Tweak GitHub actions for internal repo.
